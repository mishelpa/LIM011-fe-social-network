  ...
  const viewLogin = `
    ...
    <div class="login-register-section flex">
      <div class="login-register-body flex">
        ...
        <input class="input-log-reg style" required type="email" placeholder="Ingresa tu correo"></br>
        <input class="input-log-reg style" required type="password" placeholder="Ingresa tu contraseña"></br>
